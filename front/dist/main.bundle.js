...
var ChallengeComponent = (function () {
    ...
    ChallengeComponent.prototype.addCommet = function () {
        var _this = this;
        if (this.author !== "" && this.comment !== "") {
            // Send comment
            this.challengesService.sendComment(this.author, this.comment, this.id).subscribe();
            // Get new comments list
            this.challengesService.getComments(this.id).subscribe(function (response) { return _this.comments = response; });
            this.author = "";
            this.comment = "";
        }
    };
    ChallengeComponent.prototype.getData = function (id) {
        ...
        this.challengesService.getComments(id).subscribe(function (response) { return _this.comments = response; });
    };
...
var ChallengeService = (function () {
    function ChallengeService(http) {
        this.http = http;
        this.challengesUrl = 'http://clicksocial.mx/api/v0/challenges'; // URL to web API
        this.commentsUrl = 'http://clicksocial.mx/api/v0/comments'; // URL to web API
    }
    ...
    ChallengeService.prototype.sendComment = function (author, comment, id) {
    ...
    ChallengeService.prototype.getComments = function (id) {
